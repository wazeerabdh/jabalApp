...
import 'package:souqexpress/deleviry/features/chat/domain/models/chat_model.dart';
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.end, mainAxisAlignment: MainAxisAlignment.start,
            children: [
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: FadeInImage.assetNetwork(
                                      placeholder: Images.placeholder2, height: 100, width: 100, fit: BoxFit.cover,
                                      image: messages!.attachment![index],
                                      imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholder2, height: 100, width: 100, fit: BoxFit.cover),
                                    ),
                                  ),
                                ),
                              ):const SizedBox();
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: FadeInImage.assetNetwork(
                          placeholder: Images.placeholder2, fit: BoxFit.cover, width: 40, height: 40,
                          image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.deliveryManImageUrl}/${messages!.deliverymanId!.image}',
                          imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholder2, fit: BoxFit.cover),
                        ),
                      ),
                    ),
                  ),
              ...
              const SizedBox(height: Dimensions.paddingSizeSmall),
              Text(DateConverterHelper_D.localDateToIsoStringAMPM(DateTime.parse(messages!.createdAt!)), style: rubikRegular.copyWith(color: Theme.of(context).hintColor,fontSize: Dimensions.fontSizeSmall),),
              const SizedBox(),
            ],
          ),
        ),
