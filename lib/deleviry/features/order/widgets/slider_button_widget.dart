...
class SliderButtonWidget_D extends StatefulWidget {
  ...
  final bool disable;
  const SliderButtonWidget_D({Key? key,
  ...
  @override
  State<SliderButtonWidget_D> createState() => _SliderButtonWidget_DState();
}

class _SliderButtonWidget_DState extends State<SliderButtonWidget_D> {
  bool? flag;
