 import 'package:hexacom_user/deleviry/features/order/domain/models/product_model.dart';

class OrderDetailsModel_D {
  int? _id;
  int? _productId;
  int? _orderId;
  double? _price;
  ProductDetails? _productDetails;
  List<Variation_D>? _variation;
  ...
  List<Variation_D>? get variation => _variation;
  ...
  OrderDetailsModel_D.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    ...
    if (json['variation'] != null) {
      ...
      json['variation'].forEach((v) {
        _variation!.add(Variation_D.fromJson(v));
      });
    }
