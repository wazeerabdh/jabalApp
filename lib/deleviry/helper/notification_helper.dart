  ...
  static Future<void> initialize(FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin) async {
    ...
    flutterLocalNotificationsPlugin.initialize(initializationsSettings,
      onDidReceiveNotificationResponse: (NotificationResponse notificationResponse) async {
        ...
        try{
         int?  orderId = int.tryParse(notificationResponse.payload!);
          if(orderId != null) {

            // Get.navigator!.push(MaterialPageRoute(builder: (context) =>
            //     OrderDetailsScreen_D(orderModelItem: OrderModel_D(id: orderId))),
            // );
          }
        }catch (e) {
          debugPrint('error ===> $e');
    ...
    //
    //   Provider.of<OrderProvider_D>(Get.context!, listen: false).getAllOrders();
    //
    //   int? id = int.tryParse('${message.data['order_id']}');
    //   if(id != null){
    //     Provider.of<ChatProvider_D>(Get.context!, listen: false).getChatMessages(id);
    //   }
    // });
