import 'package:souqexpress/features/menu/domain/models/menu_model.dart';
...
import 'package:souqexpress/common/widgets/text_hover_widget.dart';
...
class ProfileHoverWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<MenuModel> list = [
      ...
      MenuModel(icon: Images.order, title: getTranslated('myorders', context), route: Routes.getOrderListScreen()),
