...
import 'package:souqexpress/common/widgets/on_hover.dart';
    ...
    return Consumer<WishListProvider>(
        builder: (context, wishListProvider, _) {
          return InkWell( onTap: () {
            Share.share("Check out this amazing content!", subject: 'Optional subject');
          },
          ...
          child: ClipRRect(
            ...
            child: Container(
              ...
              child: Stack(children: [
                ...
                if(isVertical) Positioned.fill(child: Padding(
                    padding: const EdgeInsets.all(Dimensions.paddingSizeSmall).copyWith(top: isVertical ? 45 : 10),
                    child: Align(
                      alignment: Alignment.topRight,
                      child:  SHareWishListButton(),
                    ),
                  )),


                Positioned.fill(child: Padding(
                  padding: const EdgeInsets.all(Dimensions.paddingSizeSmall).copyWith(top: isVertical ? 85 : 10),
                  child: Align(
                    alignment: Alignment.topRight,
                    child: InkWell(
                      onTap: (){
