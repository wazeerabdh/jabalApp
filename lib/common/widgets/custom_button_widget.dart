...
class CustomButtonWidget extends StatelessWidget {
  ...
  const CustomButtonWidget({
    ...
    this.radius = 10, this.iconData, this.style, this.isLoading = false, this.height,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final ButtonStyle flatButtonStyle = TextButton.styleFrom(
      ...
      minimumSize: Size(MediaQuery.of(context).size.width, height ?? 40),
    ...
    return TextButton(
      ...
      Center(child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text(
          btnTxt ?? "",
          style: style ?? rubikMedium.copyWith(color: Colors.white, fontSize: 15),
        ),
