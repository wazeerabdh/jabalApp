...
import 'package:souqexpress/common/widgets/custom_slider_list_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ProductProvider>(builder: (context, productProvider, child) {
      return productProvider.newArrivalProductsModel?.products != null &&
        ...
        isShowForwardButton: productProvider.newArrivalProductsModel != null &&
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Padding(
                ...
                child: TitleWidget(
                  ...
                  onTap: () {
                    Navigator.pushNamed(
                        context, Routes.getSearchResultRoute(shortBy: SearchShortBy.newArrivals));
                  },
                ),
              ),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemCount: productProvider.newArrivalProductsModel != null
                      ? productProvider.newArrivalProductsModel!.products!.length
                      : 5,
                  scrollDirection: Axis.horizontal,
                  itemBuilder: (ctx, index) => productProvider.newArrivalProductsModel == null
                      ? SizedBox(
