...
class _DashboardScreenState extends State<DashboardScreen> {
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: !ResponsiveHelper.isDesktop(context) ? Container(
          ...
          child: ClipRRect(
            ...
            _barItem(Icons.person, getTranslated('menu', context), 3)
                ],
                onTap: (int index) {
            _setPage(index);
                },
  ...
  BottomNavigationBarItem _barItem(IconData icon, String? label, int index) {
    return BottomNavigationBarItem(
      ...
      icon: Consumer<WishListProvider>(
        builder: (context, wishListProvider, _) {
          return Stack(
            ...
            Icon(icon, color: index == _pageIndex ? Theme.of(context).primaryColor : Colors.grey, size: 25),
      ...
      label: label,
     // activeIcon: Text(label!,style: TextStyle(color: index == _pageIndex ? Theme.of(context).primaryColor : Colors.grey,),),
    );
  }
