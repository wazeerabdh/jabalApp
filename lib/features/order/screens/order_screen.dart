...
import 'package:souqexpress/features/order/widgets/order_list_widget.dart';
import 'package:provider/provider.dart';

class OrderScreen extends StatefulWidget {
 final bool shoo;
  const OrderScreen({Key? key, required this.shoo}) : super(key: key);
...
class _OrderScreenState extends State<OrderScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: getTranslated('my_order', context,),isBackButtonExist: widget.shoo),
