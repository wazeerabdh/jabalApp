...
import 'package:souqexpress/common/widgets/theme_switch_button_widget.dart';
...
import 'package:souqexpress/features/menu/widgets/menu_web_widget.dart';
import 'package:souqexpress/features/menu/widgets/portion_widget.dart';
...
class MoneyTransfScreen extends StatefulWidget {
  const MoneyTransfScreen({Key? key}) : super(key: key);

  @override
  State<MoneyTransfScreen> createState() => _MoneyTransfScreenState();
}

class _MoneyTransfScreenState extends State<MoneyTransfScreen> {
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          PortionWidget(imageIcon: Images.order, title: getTranslated('myorders', context), route: Routes.getOrderListScreen()),
