...
import 'package:souqexpress/common/widgets/paginated_list_view.dart';
...
import 'package:souqexpress/features/flash_sale/widgets/flash_sale_timer_widget.dart';
              ...
              return Column(children: [
                ...
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
                    ...
                    Expanded(child: Image.asset(Images.flashSale, width: ResponsiveHelper.isDesktop(context) ? 250 : 110, height: ResponsiveHelper.isDesktop(context) ? 200 : 100, fit: BoxFit.cover)),
